namespace MetaMind.Session.Sessions
{
    ...
    public class SessionController : MMObject, IMMSessionController<SessionData>
    {
        ...
        private void InitializeScreen()
        {
            ...
            this.GlobalInterop.Screen.AddScreen(new BackgroundScreen(this.background));
            this.GlobalInterop.Event.QueueEvent(new MMEvent((int)SessionEvent.GameStarted, null, 3, 1));
