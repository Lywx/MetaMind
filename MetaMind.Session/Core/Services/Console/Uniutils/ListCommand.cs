...
{
    using System.Linq;
    using Engine.Core.Services.Console.Commands;
    ...
    internal class ListCommand : IConsoleCommand
    {
        ...
        {
            var listing = (from test in MMSessionGame.Session.Data.Test.AllCollection where !test.Evaluation.ResultPassed select test.Name).ToList();
