namespace MetaMind.Session.Guis.Screens
{
    ...
    using Engine.Core.Entity.Control.Buttons;
    ...
    public class MainScreen : MMScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            this.scriptRunner   = new FsScriptRunner(this.scriptSearcher, MMSessionGame.FsiSession);
            ...
            // Test session
            this.testSession = new TestSession(MMSessionGame.FsiSession, MMSessionGame.SessionData.Cognition);

            // Operation session
            this.operationSession = new OperationSession(MMSessionGame.FsiSession, MMSessionGame.SessionData.Cognition);
            ...
            this.CircularLayers.Add(new TestLayer(this.testSession, MMSessionGame.Speech, this));
        ...
        {
            MMSessionGame.SessionData.Operation.Reset();
            MMSessionGame.SessionData.Test     .Reset();
