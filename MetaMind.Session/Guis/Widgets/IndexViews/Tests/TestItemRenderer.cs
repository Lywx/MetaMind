...
namespace MetaMind.Session.Guis.Widgets.IndexViews.Tests
{
    ...
    {
        public TestItemRenderer(IMMViewItem item)
            : base(item)
        {
        }
        ...
        protected MMViewItemRectangleRender StatisticsRectangle { get; set; }
        ...
        public override void Initialize()
        {
            ...
            this.StatisticsRectangle = new MMViewItemRectangleRender(this.Item,
                this.ItemFrame.StatisticsImmRectangle,
                itemSettings.Get<MMViewItemRenderSettings>("StatisticsFrame"));
            {
