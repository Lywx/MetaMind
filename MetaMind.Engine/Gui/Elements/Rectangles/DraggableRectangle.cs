// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DraggableFrame.cs">
...
namespace MetaMind.Engine.Gui.Elements.Rectangles
{
    ...
    public class DraggableRectangle : PickableRectangle, IDraggableRectangle
    {
        ...
        {
            this[ElementState.Element_Is_Holding] = () => this.RectangleMachine.IsInState(RectangleMachineState.Holding);
            this[ElementState.Element_Is_Dragging] = () => this.RectangleMachine.IsInState(RectangleMachineState.Dragging);
        }
