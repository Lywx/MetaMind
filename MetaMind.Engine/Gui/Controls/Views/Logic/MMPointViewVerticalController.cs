namespace MetaMind.Engine.Gui.Controls.Views.Logic
{
    ...
    public class MMPointViewVerticalController : MMPointViewController, IMMPointViewVerticalController 
    {
        ...
        protected MMPointViewVerticalController(IMMViewNode view, IViewScrollController viewScroll, IViewSelectionController viewSelection, IViewSwapController viewSwap, IViewLayout viewLayout, IViewItemFactory itemFactory)
