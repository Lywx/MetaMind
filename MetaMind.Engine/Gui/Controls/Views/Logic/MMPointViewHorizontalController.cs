...
namespace MetaMind.Engine.Gui.Controls.Views.Logic
{
    ...
    public class MMPointViewHorizontalController : MMPointViewController, IMMPointViewHorizontalController 
    {
        ...
        protected MMPointViewHorizontalController(IMMViewNode view, IViewScrollController viewScroll, IViewSelectionController viewSelection, IViewSwapController viewSwap, IViewLayout viewLayout, IViewItemFactory itemFactory)
