namespace MetaMind.Engine.Entities.Controls.Item.Logic
{
    ...
    public class MMViewItemController : MMViewItemController, IMMViewItemController
    {
        ...
        public MMViewItemController(IMMViewItem item, IMMViewItemFrameController itemFrame, IMMViewItemInteraction itemInteraction, IMMViewItemDataModel itemModel, IMMViewItemLayout itemLayout)
            : base(item)
        {
            if (itemFrame == null)
            {
