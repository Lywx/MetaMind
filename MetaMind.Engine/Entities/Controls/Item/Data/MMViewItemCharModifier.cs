namespace MetaMind.Engine.Entities.Controls.Item.Data
{
    ...
    public class MMViewItemCharModifier : MMViewItemControllerComponent, IMMViewItemCharModifier, IMMViewItemCharProcessor
    {
        ...
        /// </summary>
        public event EventHandler<MMViewItemDataEventArgs> ModificationEnded
        {
            add
            {
        ...
        /// </summary>
        public event EventHandler<MMViewItemDataEventArgs> ValueModified;

        /// <summary>
        /// Occurs when modification ends as a private event, which is explicitly implemented
        /// by ModificationEnded.
        /// </summary>
        private event EventHandler<MMViewItemDataEventArgs> modificationEnded;
        ...
        private void InputEventEnterKeyDown(object sender, MMKeyEventArgs e)
        {
            if (!this.Item[MMViewItemState.Item_Is_Editing]())
            {
                return;
        ...
        {
            this.modificationEnded?.Invoke(this, new MMViewItemDataEventArgs(str));
        }

        private void OnValueModified(string str)
        {
            this.ValueModified?.Invoke(this, new MMViewItemDataEventArgs(str));
        }
        ...
        private bool ComboTriggered(IMMKeyboardInput keyboard, Keys key)
        {
