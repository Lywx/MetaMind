namespace MetaMind.Engine.Core.Backend.Audio
{
    ...
    ///     unmanaged resource.
    /// </remarks>
    public class MMAudioController : MMGeneralComponent, IMMAudioController
    {
        #region Constructors and Finalizer

        public MMAudioController(MMEngine engine, MMAudioDeviceController audioDeviceController)
            : base(engine)
        {
        ...
        private MMAudioDeviceController AudioDeviceController { get; set; }
        ...
        {
            return audio != null &&
                   audio.Name.Equals(this.audioCueCurrent.Name);
        }
        ...
        {
            if (this.IsPlaying && this.audioCueCurrent.IsStopped)
            {
                this.Pop();
            }
        ...
        public void Play(MMAudio audio)
        {
            ...
            {
                this.GlobalInterop.Console.WriteLine();
            }
        }
