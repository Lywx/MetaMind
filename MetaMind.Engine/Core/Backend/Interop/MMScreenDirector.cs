namespace MetaMind.Engine.Core.Backend.Interop
{
    ...
    using System.Linq;
    using Entity.Screens;
    using Microsoft.Xna.Framework;

    public class MMScreenDirector : ImmInputableComponent, IMMScreenDirector
    {
        #region Dependency
        ...
        private void UpdateScreensStates(GameTime time)
        {
            ...
            while (this.screensToUpdate.Count > 0)
            {
                ...
                screen.UpdateScreen(this.GlobalInterop, time, hasOtherScreenFocus, isCoveredByOtherScreen);
