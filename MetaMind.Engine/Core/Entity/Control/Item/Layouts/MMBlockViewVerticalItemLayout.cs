namespace MetaMind.Engine.Core.Entity.Control.Item.Layouts
{
    ...
    public class MMBlockViewVerticalItemLayout : MMPointViewVerticalItemLayout, IMMBlockViewVerticalItemLayout
    {
        private ItemSettings itemSettings;

        private IMMPointViewVerticalLayout viewLayout;

        #region Constructors

        public MMBlockViewVerticalItemLayout(
            IMMViewItem item,
        ...
        public override void Initialize()
        {
            ...
            this.viewLayout = this.GetViewLayer<MMBlockViewVerticalLayer>().ViewLayout;
        ...
        protected virtual void UpdateBlockString()
        {
            ...
            var frame = this.itemSettings.Get<MMViewItemRenderSettings>(this.BlockData.BlockFrame);
        ...
        public IMMBlockViewItemData BlockData => this.Item.ItemData;
