...
namespace MetaMind.Engine.Core.Entity.Control.Views.Selections
{
    ...
    public class MMPointViewHorizontalSelectionController : MMViewControlComponent, IMMPointViewHorizontalSelectionController
    {
        private IMMPointViewHorizontalScrollController viewScroll;
        ...
        public MMPointViewHorizontalSelectionController(IMMView view)
            : base(view)
        {
        }
