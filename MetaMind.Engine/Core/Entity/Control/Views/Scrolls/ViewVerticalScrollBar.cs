...
namespace MetaMind.Engine.Core.Entity.Control.Views.Scrolls
{
    ...
    public class ViewVerticalScrollbar : MMRendererComponent, IViewVerticalScrollbar
    {
        ...
        private readonly IMMPointViewVerticalLayout viewLayout;
        ...
        public ViewVerticalScrollbar(IPointViewVerticalSettings viewSettings, IMMPointViewVerticalScrollController viewScroll, IMMPointViewVerticalLayout viewLayout, IRegion viewRegion, ViewScrollbarSettings scrollbarSettings)
        {
