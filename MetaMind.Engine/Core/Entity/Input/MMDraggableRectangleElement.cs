namespace MetaMind.Engine.Core.Entity.Input
{
    ...
    public class MMDraggableRectangleElement : MMPickableRectangleElement, IMMDraggableRectangleElement
    {
        ...
        {
            this[MMElementState.Element_Is_Holding] = () => this.RectangleStateMachine.IsInState(RectangleMachineState.Holding);
            this[MMElementState.Element_Is_Dragging] = () => this.RectangleStateMachine.IsInState(RectangleMachineState.Dragging);
        }
