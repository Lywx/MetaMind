namespace MetaMind.Engine.Guis.Widgets.Views.PointView
{
    ...
    public class PointView1DSettings : ViewSettings
    {
        ...
        public PointView1DSettings(Point start)
        {
            this.PointStart = start;
        }

        public PointView1DSettings(Point start, Point margin, PointView1DDirection direction)
        {
            this.PointStart  = start;
