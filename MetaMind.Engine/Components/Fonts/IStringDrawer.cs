namespace MetaMind.Engine.Components.Fonts
{
    ...
    public interface IStringDrawer : IGameComponent
    {
        ...
        void DrawMonospacedString(Font font, string str, Vector2 position, Color color, float scale, StringHAlign HAlign, StringVAlign VAlign);
        ...
        void DrawString(Font font, string str, Vector2 position, Color color, float scale, StringHAlign HAlign, StringVAlign VAlign);
    }
}