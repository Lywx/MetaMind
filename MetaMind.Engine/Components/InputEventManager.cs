...
{
    public class InputEventManager : GameComponent
    {
        #region Manager Data
        ...
        /// It is only set to true by HandleInput method.
        /// </summary>
        /// <value>
        ...
        private IntPtr hIMC;
        private WndProc hookProcDelegate;
        ...
        #endregion Mouse Message Helpers
