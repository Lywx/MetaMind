namespace MetaMind.Engine.Components.Graphics
{
    ...
    /// <summary>
    /// Renderer Manager is a wrapper class around the GraphicsDevice. 
    /// </summary>
    public class MMRenderDeviceController : MMInputableComponent
    {
        #region Constructors and Finalizer

        public MMRenderDeviceController(MMEngine engine) : base(engine)
        {
            this.effectDefault = new BasicEffect(this.GraphicsDevice);
        ...
        public void DrawTexture(MMTextureItem item)
        {
