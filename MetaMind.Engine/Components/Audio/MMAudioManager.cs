...
namespace MetaMind.Engine.Components.Audio
{
    ...
    ///     unmanaged resource.
    /// </remarks>
    public class MMAudioManager : GameComponent, IMMAudioManager
    {
        public MMAudioManager(MMEngine engine, AudioEngine audioEngine, WaveBank waveBank, SoundBank soundBank)
            : base(engine)
        {
            if (engine == null)
            {
