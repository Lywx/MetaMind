namespace MetaMind.Acutance.Guis.Widgets
{
    ...
    public class TraceItemLogicControl : ViewItem2DLogicControl
    {
        #region Constructors

        public TraceItemLogicControl(IViewItem item, List<Trace> source)
            : base(item)
        {
        ...
        private void DeleteIt()
        {
            ...
            View.Logic.ItemFactory.RemoveData(Item);
