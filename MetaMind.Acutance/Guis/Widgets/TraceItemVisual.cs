namespace MetaMind.Acutance.Guis.Widgets
{
    ...
    public class TraceItemVisual : ViewItemVisual
    {
        #region Constructors

        public TraceItemVisual(IViewItem item)
            : base(item)
        {
        }
        ...
        {
            get { return ExtPoint.ToVector2(this.ItemLogic.IdFrame.Center); }
        }
        ...
        protected virtual Vector2 NameLocation
        {
            ...
            {
                return new Vector2(
                    this.ItemLogic.NameFrame.Location.X + ItemSettings.NameXLMargin,
                    this.ItemLogic.NameFrame.Location.Y + ItemSettings.NameYTMargin);
            }
        }
        ...
        {
            if (!this.ItemLogic.Active && !Item.IsEnabled(ItemState.Item_Is_Dragging))
            {
                return;
            }
        ...
        protected void DrawExperienceFrame(byte alpha)
        {
            Primitives2D.FillRectangle(
                ...
                ExtRectangle.Crop(this.ItemLogic.ExperienceFrame.Rectangle, ItemSettings.ExperienceFrameMargin),
        ...
        protected void DrawIdFrame(byte alpha)
        {
            Primitives2D.FillRectangle(
                ScreenManager.SpriteBatch,
                ExtRectangle.Crop(this.ItemLogic.IdFrame.Rectangle, ItemSettings.IdFrameMargin),
