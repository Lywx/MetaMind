// --------------------------------------------------------------------------------------------------------------------
// <copyright file="KnowledgeItemLogicControl.cs" company="UESTC">
...
namespace MetaMind.Acutance.Guis.Widgets
{
    ...
    public class KnowledgeItemLogicControl : ViewItem2DLogicControl
    {
        #region Constructors

        public KnowledgeItemLogicControl(IViewItem item)
            : base(item)
        {
