namespace MetaMind.Acutance.Guis.Widgets
{
    ...
    public class EventViewControl : ViewControl2D
    {
        #region Constructors

        public EventViewControl(IView view, EventViewSettings viewSettings, EventItemSettings itemSettings, TraceItemFactory itemFactory)
