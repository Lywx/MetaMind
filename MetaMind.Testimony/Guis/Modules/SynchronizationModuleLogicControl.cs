namespace MetaMind.Testimony.Guis.Modules
{
    ...
    public class SynchronizationModuleLogicControl : ModuleLogicControl<SynchronizationModule, SynchronizationSettings, SynchronizationModuleLogicControl>
    {
        public SynchronizationModuleLogicControl(SynchronizationModule module, IConsciousness consciousness, ISynchronization synchronization)
            : base(module)
        {
        ...
        private class SleepStartedListener : Listener
        {
            ...
            private readonly SynchronizationModuleLogicControl synchronizationLogicControl;

            public SleepStartedListener(ISynchronization synchronization, SynchronizationModuleLogicControl synchronizationLogicControl)
            {
                this.synchronization        = synchronization;
                this.synchronizationLogicControl = synchronizationLogicControl;
            ...
            public override bool HandleEvent(IEvent @event)
            {
                ...
                {
                    this.synchronizationLogicControl.Stop();
                }
                ...
                // Quit monitoring 
                this.synchronizationLogicControl.Exit();
        ...
        private class SynchronizationStoppedListener : Listener
        {
            ...
            public SynchronizationStoppedListener(ISynchronization synchronization, SynchronizationModuleLogicControl synchronizationLogicControl)
            {
                this.synchronization        = synchronization;
                this.synchronizationLogicControl = synchronizationLogicControl;
