namespace MetaMind.Testimony.Guis.Modules
{
    ...
    using MetaMind.Testimony.Extensions;
    using MetaMind.Testimony.Guis.Modules.Summary;

    using Microsoft.Xna.Framework;

    public class SummaryModuleVisualControl : ModuleVisualControl<SummaryModule, SummarySettings, SummaryModuleLogicControl>
    {
        public SummaryModuleVisualControl(SummaryModule module, IConsciousness consciousness, ISynchronization synchronization)
            : base(module)
        {
